...
public class RadiusUserRepositoryImpl implements RadiusUserRepository {
    ...
    public Page<RadiusUser> findAllWithRange (Integer pageNumber, Integer limit) {
        ...
        Page<RadiusUser> page = new PageFactory<RadiusUser>(pageNumber, limit, total).createPage();
    ...
    public Page<RadiusUser> findAllOfOrderWithRange (String someLogin, Integer pageNumber, Integer limit) {
        ...
        Page<RadiusUser> page = new PageFactory<RadiusUser>(pageNumber, limit, getTotalRecords(s)).createPage();
    ...
    private Long getTotalRecords (String someLogin) {

        return this.jdbcTemplate.queryForObject("select count(*) from ruser where username like ? ", new Object[] {someLogin}, new RowMapper<Long>() {
            @Override
            public Long mapRow (ResultSet rs, int rowNum) throws SQLException {
                return rs.getLong(1);
            }
